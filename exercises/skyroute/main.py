...
def greet():
    ...
    print("We'll help you find the shortest route between the following Cancouver landmarks:\n")
...
def get_piont(inputMsg): a
  point_letter = input(inputMsg)
   if point_letter in landmark_choices:
        point = landmark_choices[point_letter]
        return point
    else:
        print("Sorry, that's not a landmark we have data on. Let's try this again...")
        return get_piont(inputMsg)

def get_start():
    return get_piont("Where are you coming from? Type in the corresponding letter: ")

def get_end():
    return get_piont("Ok, where are you headed? Type in the corresponding letter: ")
